...
<body>
    <div class="container mt-5">
        ...
        <div class="row mb-5">
            <div class="col-12">
                <table class="table table-borderless">
                    ...
                    <tr>
                        <td class="label-col">Préstamo #:</td>
        ...
        <div class="document-fotos">
            <?php foreach ($fotos as $index => $foto): ?>
            <div class="document-foto">
                <img src="<?= htmlspecialchars(file_url($foto['Ruta'])) ?>"
                     alt="Fotografía de evidencia <?= (int) $index + 1 ?>">
            </div>
            <?php endforeach; ?>
        </div>
        <?php endif; ?>
