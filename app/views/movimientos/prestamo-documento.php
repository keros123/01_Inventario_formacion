...
<body>
    <div class="container mt-5">
        ...
        <div class="document-header">
            ...
            <h2 class="document-number">Documento de Préstamo #<?= $prestamo['Consecutivo'] ?></h2>
        </div>
            ...
            <div class="col-12">
                <table class="table table-borderless">
                    <tr>
                        ...
                        <td><?= htmlspecialchars(date('d/m/Y', strtotime($prestamo['Fecha']))) ?></td>
                    </tr>
                    <tr>
                        <td class="label-col">Cédula</td>
                        <td><?= htmlspecialchars($prestamo['Cedula_cuentadante']) ?></td>
                    </tr>
                    <tr>
                        <td class="label-col">Nombre</td>
                        <td><?= htmlspecialchars($prestamo['Cuentadante']) ?></td>
                    </tr>
                </table>
            </div>
        </div>

        <h3 class="mb-3">Detalles del Préstamo:</h3>
        <table class="table table-bordered table-document">
            ...
            <tbody>
                ...
                <tr>
                    <td><code style="color: #2b579a;"><?= htmlspecialchars($detalle['Codigo_elemento']) ?></code></td>
        ...
        <div class="mt-4">
            ...
            <p class="text-muted"><?= htmlspecialchars($prestamo['Descripcion']) ?></p>
        </div>
        <?php endif; ?>
