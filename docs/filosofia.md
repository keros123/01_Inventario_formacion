...
- **Despliegue:** imagen Docker (`docker compose up`) o LAMP local (XAMPP), carpeta pública en `public/`. En el contenedor la URL base es la raíz; en XAMPP se detecta sola.
